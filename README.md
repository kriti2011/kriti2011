...
| [**Graduate Admissions Prediction – Jamboree Case Study**](https://github.com/kriti2011/Jamboree-Case-Study) | Predicted **chances of admission into Ivy League colleges** based on student profiles (GRE, TOEFL, CGPA, SOP, LOR, Research). | EDA, Regression Modeling, Feature Importance, Predictive Analytics | Python, Pandas, Seaborn, Linear Regression |
